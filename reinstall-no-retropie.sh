#!/usr/bin/env bash
# =============================================================================
# NEXTCLOUDPI SERVER — REINSTALL WITHOUT RETROPIE
# =============================================================================
...
#        sudo bash reinstall-no-retropie.sh 2>&1 | tee /tmp/reinstall.log
#
...
if [[ -n "$LATEST_BACKUP" ]]; then
    ...
    info "Restore via NCP web UI (https://192.168.1.6:4443) OR:  sudo ncp-restore \"$LATEST_BACKUP\""
else
...
sudo -u www-data php /var/www/nextcloud/occ maintenance:repair 2>/dev/null || \
    warn "occ maintenance:repair failed — run after DB restore"
...
todo "Clone/restore prode-mundial to /home/pi/prode-mundial/ (docker-compose.yml + images)"
todo "Then run: cd /home/pi/prode-mundial && docker compose up -d"

info "Starting main Docker stack..."
cd /home/$PI_USER
...
todo "Clone finance-tracker to /home/pi/finance-tracker"
...
todo "Restore /home/pi/translation-tool/.env"
...
todo "Restore /home/pi/update-ddns.sh        (Dynamic DNS updater)"
...
todo "10. NCP DB restore: sudo ncp-restore <file> OR web UI https://192.168.1.6:4443"
todo "11. TLS certs: certbot --apache -d erebor.home.kg -d fulbo.home.kg -d mellon.home.kg"
todo "12. Reboot and verify:  systemctl list-units --failed"
echo ""
